...
<body>
  ...
  <div class="container">
    ...
    <div>
      <br></br>
     <div><h1>WAKTU SOLAT MALAYSIA</h1></div>
    <iframe src="https://www.e-solat.gov.my/" style="border:0px #ffffff none;" name="myiFrame" scrolling="no" frameborder="1" marginheight="0px" marginwidth="0px" height="700px" width="750px" allowfullscreen></iframe>
    </div>
